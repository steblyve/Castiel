...
class LevelTest {
	...
	private Locker CreateLocker(String[] description, String response, Item containedItem, Item neededKey,
			Interaction UnlockInteraction, Interaction[] generalInteractions) {
		return null;
	}
